...
def main(argv):
    ...
    while sim_it < n_sim:
        ...
        while not equilibrium:
            ...
            sol = solve_ivp(model, t_span, z_0, args = (A, B, n), 
                            dense_output = True)
            ...
            if ext_ind:
                plant_ab = np.insert(plant_ab, 0, ext_ind, axis = 0)
                soil_ab = np.insert(soil_ab, 0, ext_ind, axis = 0)
            ...
            print('Number of integrations: ', n_int, end = '\r')
            if n_int > n_int_max:
                break
